...
<body style="width: 100vw; background-color: #1f1f1f; overflow-y: hidden; overflow-x: hidden;">

<div id="column0" style="width: 30%; float: left;"></div>
<div id="column1" style="width: 30%; float: left;"></div>
<div id="column2" style="width: 30%; float: left;"></div>
</body>
</html>"""
}
